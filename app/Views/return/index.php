            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Return Darah</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-sm table-hover">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="10" class="text-center text-muted">Tidak ada data return</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    ...
                    <div class="d-flex justify-content-between">
                        <div>
                            <p class="text-muted">
                                Menampilkan <?= count($return) ?> dari <?= $pager->getTotal() ?> data
                            </p>
                        </div>
                        <div>
                            <?= $pager->links() ?>
